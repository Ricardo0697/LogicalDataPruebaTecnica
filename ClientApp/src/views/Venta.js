        ...
        <Row>
            <Col sm={8}>
                ...
                <Row className="mb-2">
                    <Col sm={12}>
                        <Card>
                            <CardHeader style={{ backgroundColor: '#0f307e', color: "white" }}>
                                Cliente
                            </CardHeader>
                            <CardBody>
                                <Row>
                        ...
                        <Card>
                            ...
                            <CardBody>
                                ...
                                <Row className="mb-2">
                                    <Col sm={12}>
                                        <InputGroup size="sm" >
                                            <InputGroupText>IVA (13%):</InputGroupText>
                                            <Input disabled value={iva} />
                                        </InputGroup>
                                    </Col>
                                </Row>
                                <Row>
